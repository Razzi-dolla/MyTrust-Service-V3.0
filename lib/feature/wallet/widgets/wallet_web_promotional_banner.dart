  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<WalletController>(
      builder: (walletController){
        if((Get.find<SplashController>().configModel.content?.addFundToWallet == 0) ||  (walletController.bonusList != null && walletController.bonusList!.isEmpty)){
          return const SizedBox();
        }else{
          return Container(alignment: Alignment.center,
            margin: const EdgeInsets.only(top: Dimensions.paddingSizeLarge,left: 5, right: 5),
            child: SizedBox(width: Dimensions.webMaxWidth, height: Get.find<LocalizationController>().isLtr ? 110 : 122,
                      ...
                      child: InkWell(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(shape: BoxShape.circle,
                            color: Colors.white70.withOpacity(0.6), boxShadow: Get.find<ThemeController>().darkTheme ? null : cardShadow,
                          ),
                  ...
                  child: Padding(padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeExtraLarge),
                    child: InkWell(
                      ...
                      child: Container(height: 30, width: 30, alignment: Alignment.center,
                        decoration: BoxDecoration(shape: BoxShape.circle, color: Colors.white70.withOpacity(0.6), boxShadow: Get.find<ThemeController>().darkTheme ? null : cardShadow),
