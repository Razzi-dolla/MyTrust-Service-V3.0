import 'package:MyTrust/common/widgets/custom_time_picker.dart';
import 'package:MyTrust/feature/checkout/widget/order_details_section/custom_repeat_booking_expansion_tile.dart';
            ...
            child: CustomRepeatBookingExpansionTile(
              ...
              children: [
                Padding(padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeSmall),
                  child: Divider(height: 1, thickness: 1, color: Theme.of(context).hintColor.withOpacity(0.2)),
                ),
                const SizedBox(height: Dimensions.paddingSizeSmall),
