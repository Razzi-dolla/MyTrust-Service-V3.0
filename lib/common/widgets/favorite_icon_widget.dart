...
class FavoriteIconWidget extends StatefulWidget {
  ...
  const FavoriteIconWidget({super.key,  this.value, this.serviceId, this.providerId, this.signInShakeKey, this.showDialog, this.index}) ;
    ...
    return InkWell(
      ...
      child: Padding(
        ...
        child: ScaleTransition(
          ...
          child: Image.asset(widget.value == 1 ? Images.favorite : Images.unFavorite, width: 23,),
        ),
      ),
    );
  }
